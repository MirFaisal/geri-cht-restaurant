...
riceElement.addEventListener('mouseover', function () {
    background_1.style.background = 'url(images/food/rice-3.png)';

});
pestyElement.addEventListener("mouseover", function () {
  background_1.style.background = 'url(images/food/pesty.png)';
});
chocolateElement.addEventListener("mouseover", function () {
  background_1.style.background = 'url(images/food/chocolate.png)';
});
